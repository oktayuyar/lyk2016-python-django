...
class Bitkiler(Canli):
    ...
    def __init__(self, isim, yaprak_turu, max_uzunluk):
        super().__init__(isim)
...
class odunsu(Bitkiler):
    def __init__(self, isim, yaprak_turu, max_uzunluk,sure):
        super().__init__(isim, yaprak_turu, max_uzunluk)
        self.sure=sure

    def yasam_uzunlugu(self):
        print("(" + self.isim + ") bitkisi (" + self.sure + ")yıl yaşarlar")
